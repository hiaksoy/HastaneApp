...
namespace HastaneApp.Views
{
    public class RandevusController : Controller
    {
        ...
        public RandevusController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Randevular != null ? 
                          ...
                          Problem("Entity set 'DatabaseContext.Randevular'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Doktor,Gun,Saat")] Randevu randevu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Doktor,Gun,Saat")] Randevu randevu)
        {
            if (id != randevu.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseContext.Randevular'  is null.");
            }
            var randevu = await _context.Randevular.FindAsync(id);
            if (randevu != null)
            {
