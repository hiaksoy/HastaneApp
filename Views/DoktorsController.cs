...
namespace HastaneApp.Views
{
    public class DoktorsController : Controller
    {
        ...
        public DoktorsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Doktorlar != null ? 
                          ...
                          Problem("Entity set 'DatabaseContext.Doktorlar'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Poliklinik,CalismaGunleri,CalismaSaatleri")] Doktor doktor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Poliklinik,CalismaGunleri,CalismaSaatleri")] Doktor doktor)
        {
            if (id != doktor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseContext.Doktorlar'  is null.");
            }
            var doktor = await _context.Doktorlar.FindAsync(id);
            if (doktor != null)
            {
